  ...
  return (
    <div className="relative flex flex-col justify-center min-h-screen p-4" style={{ backgroundImage: `url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRx2CuUHpaeR3wQh5eJck3BrqSKrooJu3JeA&shttps://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRx2CuUHpaeR3wQh5eJck3BrqSKrooJu3JeA&s")`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="relative flex flex-col items-center md:flex-row md:items-start">
        <motion.div
          className="relative flex items-center justify-center mb-4 md:mb-0 md:mr-8"
        ...
        <motion.div
          className="relative text-white text-justify text-lg md:mt-0 mt-4"
          initial={{ x: 100, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 1 }}
        >
          <p className="md:w-1/2">
            MP Films has multiple, rich shooting locations, an ultimate mixture of Wildlife, Leisure, and Heritage. The wide panorama of geographical variations, variety of heritage assets, lively urban locals, peaceful Ghats, exposure to world heritage sites coupled with the ease on procedures required to fulfill the shooting formalities have been some of the key factors that have raised Madhya Pradesh among the top shooting destinations. Here are some top cities from the wishlist of renowned directors - Bhopal, Indore, Gwalior, Jabalpur, Chhatarpur, Chhindwara, Maheshwar, Omkarehwar, Ujjain, Hoshangabad, Panna, Bundelkhand, Bhedaghat, Mandu, Orchha, Pachmarhi.
            <br /><br />
            Madhya Pradesh has emerged as a shooting friendly state for all kinds of filming activities. Our Madhya Pradesh government, administration, and MP Tourism & Film board are very co-operative and supportive at every filming step. The government of Madhya Pradesh is also giving maximum subsidy benefits to filmmakers from all around INDIA for feature films, web-series, documentaries, TV-serials & web films.
          </p>
        </motion.div>
      </div>
    </div>
