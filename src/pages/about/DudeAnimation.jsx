    ...
    return (
        <div className="page">
            ...
            <div className="animation-container flex flex-row gap-2 items-start w-full justify-start">
                <svg className="w-fit scale-50 md:scale-100 -translate-x-1/3 md:translate-x-0" viewBox="0 -10 315 350">
               ...
               <svg className="invert  scale-50 md:scale-100 -translate-x-[300%] md:-translate-x-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org" id="camera-loader" width="85.708488"  height={100}>
  <defs id="defs12" />
