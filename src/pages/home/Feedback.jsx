...
const Feedback = () => {
  ...
  return (
    <div className="p-4 relative" style={{ backgroundImage: `url("https://faime-next.vercel.app/_next/static/media/testimonial.9c4d3c06.png")` }}>
      <div className="absolute inset-0 bg-black opacity-80"></div>
      <div className="relative text-right text-[#ED1C24] text-2xl  mr-40  mb-5 mt-5">FEEDBACK</div>
      <div className="relative text-right text-white text-6xl text-bold mb-8 mr-20">Customer Feedback</div>
      ...
      <div className="relative carousel w-full flex justify-center gap-4 flex-wrap">
        {feedbacks.slice(currentPage * 2, currentPage * 2 + 2).map(feedback => (
          <div key={feedback.id} className='w-full rounded-2xl md:w-5/12 h-96 bg-white flex flex-col items-center justify-center p-4'>
